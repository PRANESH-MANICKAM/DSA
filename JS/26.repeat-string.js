// Write code that enhances all strings such that you can call the string.replicate(x) method on any string
// and it will return repeated string x times.
...
const strReply = (str, times) => {
  return str.repeatStr(times);
};

console.log(strReply("pranesh", 5))
